...
#define FTP_DEFAULT_BUFFER			1024*1024*4							//FTP下载缓冲默认大小
#define FTP_DEFAULT_PATH			"/home/yg/cftpmanager/"						//FTP默认保存路径
...
private:
	...
	// 下载文件到string
	FTP_API downLoadToStr(const std::string &strRemoteFile, const std::string &strLocalFile, const int pos = 0, const unsigned int length = 0);
