...
#ifndef SRC_PLUGINS_REALTIME_REALTIME_CODE_INFO_H_
#define SRC_PLUGINS_REALTIME_REALTIME_CODE_INFO_H_
...
typedef StockDB::CodeRealtimeInfo DbCodeInfo;
class StockRealInfo {
 public:
  enum {
    CODE = 0,
...
#endif /* SRC_PLUGINS_REALTIME_REALTIME_CODE_INFO_H_ */
